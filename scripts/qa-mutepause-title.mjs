...
await page.screenshot({ path: "/workspace/screenshots/mutepause-title-after.png" });

const info = await page.evaluate(() => {
  const H = window.__HAEMU__;
  const btn = document.getElementById("mutePauseBtn");
...
if (info.title !== "소리 (M)") fail.push("title " + info.title);
