...
1. 걷기 4×4 시트 (지금은 4방향 대기 + 걷기 바운스). 별도 PR `cursor/commando-walk-art-f6c7`
2. 담장(`kind==='wall'`)은 아직 코드 드로우. 별도 PR `cursor/wall-prerender-9678`
3. 백서 3차 D13–D15는 다른 PR
4. 실제 샘플 효과음 없음 (신스만)

2층 동선·창문 사격선·조수는 2026-08-22 에 검증·수정함. 조수 공식은 그대로.
