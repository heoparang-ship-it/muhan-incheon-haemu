...
튜토리얼 바닥은 `game/assets/maps/tut01_ground.png`. 천막·상자·가마니·수레·그물은 `game/assets/maps/obj/`에서 따로 올린다. 길은 아직 옛 칸. 스토리는 [`docs/TUTORIAL.md`](docs/TUTORIAL.md).
...
| 층 | 내용 |
|---|---|
| 장 | `tut01` 감나루 하선(32×32, 해주·무진) / `ch1` 감나루(96×96, 4인) |
